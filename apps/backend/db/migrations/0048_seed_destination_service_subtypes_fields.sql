-- 0048: Seed subtypes, fields, and channel linkages for destination + service
--
-- Depends on 0047 which added 'destination' and 'service' to catalog_type ENUM.
-- Split from 0047 because PostgreSQL cannot use new enum values in the same
-- transaction where they were added.

-- ============================================================================
-- 1. Seed feed_catalog_subtypes
-- ============================================================================
...
-- ============================================================================
-- 2. Seed Destination fields (16 fields: 5 required + 11 optional)
-- ============================================================================
...
-- ============================================================================
-- 3. Seed Service fields (13 fields: 4 required + 9 optional)
-- ============================================================================
...
-- ============================================================================
-- 4. Link Destination fields to facebook_destination_ads channel
-- ============================================================================
...
-- ============================================================================
-- 5. Link Service fields to facebook_professional_services channel
-- ============================================================================
