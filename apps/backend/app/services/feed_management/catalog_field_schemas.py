...
DESTINATION_FIELDS: List[CatalogField] = [
    CatalogField(
        name="id",
        display_name="ID",
    ...
    CatalogField(
        ...
        required=True,
        category="basic",
        facebook_attribute="name",
    ),
    CatalogField(
        name="url",
        display_name="URL",
        description="URL to the destination page",
        field_type=FieldType.URL,
        required=True,
        category="basic",
        facebook_attribute="url",
    ),
    CatalogField(
        name="image_link",
        display_name="Image Link",
    ...
    CatalogField(
        ...
        description="Price indication or range",
        field_type=FieldType.STRING,
        required=False,
        category="pricing",
    ),
...
SERVICE_FIELDS: List[CatalogField] = [
    CatalogField(
        name="id",
        display_name="ID",
    ...
    CatalogField(
        name="url",
        display_name="URL",
        description="URL to the service page",
        field_type=FieldType.URL,
        required=True,
        category="basic",
        facebook_attribute="url",
    ...
    CatalogField(
        name="price",
        display_name="Price",
        description="Service price or starting price",
        field_type=FieldType.PRICE,
        required=False,
        category="pricing",
        facebook_attribute="price",
    ...
    CatalogField(
        ...
        required=False,
        category="basic",
        enum_values=["available", "unavailable", "by_appointment"],
    ),
    CatalogField(
        name="area_served",
