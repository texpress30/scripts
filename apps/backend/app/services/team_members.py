...
AGENCY_NAVIGATION_CATALOG: tuple[ModuleCatalogItem, ...] = (
    ...
    ModuleCatalogItem(key="agency_media", label="Media Storage", order=7, scope="agency", group_key="main_nav", group_label="Main Navigation"),
    ModuleCatalogItem(key="agency_audit", label="Audit", order=8, scope="agency", group_key="main_nav", group_label="Main Navigation"),
    ModuleCatalogItem(key="creative", label="Creative", order=9, scope="agency", group_key="main_nav", group_label="Main Navigation"),
    ModuleCatalogItem(key="email_templates", label="Email Templates", order=10, scope="agency", group_key="main_nav", group_label="Main Navigation"),
    ModuleCatalogItem(key="notifications", label="Notifications", order=11, scope="agency", group_key="main_nav", group_label="Main Navigation"),
...
SUBACCOUNT_NAVIGATION_CATALOG: tuple[ModuleCatalogItem, ...] = (
    ...
    ModuleCatalogItem(key="settings_personal_profile", label="Profil", order=105, scope="subaccount", group_key="settings", group_label="Settings", parent_key="settings"),
