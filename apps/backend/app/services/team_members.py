...
AGENCY_NAVIGATION_CATALOG: tuple[ModuleCatalogItem, ...] = (
    ...
    ModuleCatalogItem(key="agency_audit", label="Audit", order=6, scope="agency", group_key="main_nav", group_label="Main Navigation"),
    ModuleCatalogItem(key="creative", label="Creative", order=7, scope="agency", group_key="main_nav", group_label="Main Navigation"),
    ModuleCatalogItem(key="email_templates", label="Email Templates", order=8, scope="agency", group_key="main_nav", group_label="Main Navigation"),
    ModuleCatalogItem(key="notifications", label="Notifications", order=9, scope="agency", group_key="main_nav", group_label="Main Navigation"),
