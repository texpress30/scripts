...
class UnifiedDashboardService:
    ...
    def _client_reporting_currency_decision(self, *, client_id: int) -> dict[str, object]:
        ...
        reporting_currency = self._normalize_currency_code(decision.get("reporting_currency"), fallback="USD")
        return {
            "reporting_currency": reporting_currency,
            "reporting_currency_source": str(decision.get("reporting_currency_source") or "safe_fallback"),
