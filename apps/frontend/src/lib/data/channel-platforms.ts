...
export const CHANNEL_PLATFORMS: Platform[] = [
  {
    ...
    sortOrder: 1,
    channels: [
      { slug: "google_shopping", displayName: "Google Shopping", compatibleSubtypes: ["product_physical", "vehicle_listings"] },
      ...
      { slug: "google_local_inventory", displayName: "Google Local Inventory", compatibleSubtypes: ["product_physical"] },
      { slug: "google_product_reviews", displayName: "Google Product Reviews", compatibleSubtypes: ["product_physical"] },
      { slug: "google_regional_inventory", displayName: "Google Regional Inventory", compatibleSubtypes: ["product_physical"] },
      { slug: "google_manufacturers", displayName: "Google Manufacturers Feed", compatibleSubtypes: ["product_physical"] },
  ...
  },
  {
    ...
    channels: [
      ...
      { slug: "facebook_country", displayName: "Meta Country Feed", compatibleSubtypes: ["product_physical"] },
      { slug: "facebook_language", displayName: "Meta Language Feed", compatibleSubtypes: ["product_physical"] },
  ...
  },
  {
    ...
    sortOrder: 4,
    channels: [
      { slug: "bing", displayName: "Bing Shopping", compatibleSubtypes: ["product_physical", "vehicle_listings"] },
    ],
  },
  {
    platform: "social",
    ...
    sortOrder: 5,
    channels: [
      { slug: "pinterest", displayName: "Pinterest", compatibleSubtypes: ["product_physical"] },
      { slug: "snapchat", displayName: "Snapchat", compatibleSubtypes: ["product_physical"] },
      { slug: "linkedin", displayName: "LinkedIn", compatibleSubtypes: ["product_physical"] },
      { slug: "twitter", displayName: "X (Twitter)", compatibleSubtypes: ["product_physical"] },
      { slug: "reddit_catalog", displayName: "Reddit Catalog Ads", compatibleSubtypes: ["product_physical"] },
      { slug: "criteo", displayName: "Criteo", compatibleSubtypes: ["product_physical"] },
      { slug: "trade_desk", displayName: "The Trade Desk", compatibleSubtypes: ["product_physical"] },
      { slug: "perplexity", displayName: "Perplexity Shopping", compatibleSubtypes: ["product_physical"] },
      { slug: "gpt_shopping", displayName: "GPT Shopping", compatibleSubtypes: ["product_physical"] },
    ],
  },
  {
    ...
    sortOrder: 10,
    channels: [
      { slug: "compari_ro", displayName: "Compari.ro", compatibleSubtypes: ["product_physical"] },
      { slug: "okazii_ro", displayName: "Okazii.ro", compatibleSubtypes: ["product_physical"] },
      { slug: "price_ro", displayName: "Price.ro", compatibleSubtypes: ["product_physical"] },
      { slug: "shopmania_ro", displayName: "Shopmania.ro", compatibleSubtypes: ["product_physical"] },
      { slug: "glami_ro", displayName: "Glami.ro", compatibleSubtypes: ["product_physical"] },
    ],
  },
  {
    platform: "affiliate",
    ...
    sortOrder: 15,
    channels: [
      { slug: "daisycon", displayName: "Daisycon", compatibleSubtypes: ["product_physical"] },
      { slug: "klarna", displayName: "Klarna", compatibleSubtypes: ["product_physical"] },
      { slug: "awin", displayName: "Awin", compatibleSubtypes: ["product_physical"] },
      { slug: "shareasale", displayName: "ShareASale", compatibleSubtypes: ["product_physical"] },
    ],
  },
];
