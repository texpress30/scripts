          ...
          <section className="wm-card rounded-lg p-5 shadow-sm">
            ...
            <div className="mt-5 grid grid-cols-1 gap-6 xl:grid-cols-[260px_1fr]">
              ...
              <form noValidate onSubmit={submit} className="space-y-5">
                ...
                <div className="rounded-lg border border-slate-200 p-4">
                  <h3 className="text-sm font-semibold text-slate-800">Semnătură Utilizator</h3>
                  <p className="mt-1 text-xs text-slate-500">Adaugă textul semnăturii utilizatorului pentru email-uri sau mesaje generate automat.</p>
                  <textarea
                    rows={4}
                    placeholder="Semnătură"
                    className="wm-input mt-3"
