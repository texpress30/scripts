...
export function CsvImportModal({ open, onClose, clientId, previewData, onPreviewLoaded }: CsvImportModalProps) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Preview summary (after successful upload) */}
        {previewData && (
          <div className="mt-3 rounded-md border border-emerald-200 bg-emerald-50 px-3 py-2 text-sm text-emerald-700">
            Preview: {previewData.total} rânduri ({previewData.valid} valide, {previewData.errors} erori)
          </div>
        )}
