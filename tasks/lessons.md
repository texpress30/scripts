...
- 2026-03-17: Pentru erori build Vercel de tip `Duplicate identifier` (ex. `TeamUser`), verifică dacă un merge anterior a stivuit o definiție mock peste o definiție nouă din API și unifică tipul ștergând duplicatul în loc de a aplica redenumiri oarbe.